...
class Todos extends amplify_core.Model {
  ...
  const Todos._internal({required this.id, task, required isDone, createdAt, updatedAt}): _task = task, _isDone = isDone, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todos({String? id, String? task, required bool isDone}) {
